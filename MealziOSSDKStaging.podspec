...
Pod::Spec.new do |spec|
    ...
    spec.source            = { :http => 'https://github.com/MealzStaging/MealziOSSDKRelease/raw/release/5.2.4-alpha/MealziOSSDK.zip' }
    spec.dependency 'MealzCoreStaging', '~> 5.2.3'
